...
module Homebrew extend self
  ...
  def git_init_if_necessary
    if Dir['.git/*'].empty?
      ...
      safe_system "git remote add origin https://github.com/Homebrew/linuxbrew.git"
      safe_system "git fetch origin"
      safe_system "git reset --hard origin/master"
    end

    if `git remote show origin -n` =~ /Fetch URL: \S+mxcl\/homebrew/
      safe_system "git remote set-url origin https://github.com/Homebrew/linuxbrew.git"
