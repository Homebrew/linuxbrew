...
############# HELPERS
  # Finds files in HOMEBREW_PREFIX *and* /home7/tvctopin/gnu.
  # Specify paths relative to a prefix eg. "include/foo.h".
  # Sets @found for your convenience.
  def find_relative_paths *relative_paths
    @found = %W[#{HOMEBREW_PREFIX} /home7/tvctopin/gnu].uniq.inject([]) do |found, prefix|
...
############# END HELPERS
	...
	def check_access_usr_local
	  return unless HOMEBREW_PREFIX.to_s == '/home7/tvctopin/gnu'

	  unless File.writable_real?("/home7/tvctopin/gnu") then <<-EOS.undent
	    The /home7/tvctopin/gnu directory is not writable.
	    Even if this directory was writable when you installed Homebrew, other
	    software may change permissions on this directory. Some versions of the
	    "InstantOn" component of Airfoil are known to do this.

	    You should probably change the ownership and permissions of /home7/tvctopin/gnu
	  ...
	  unless find_relative_paths("lib/libiconv.dylib", "include/iconv.h").empty?
	    if (f = Formula.factory("libiconv") rescue nil) and f.linked_keg.directory?
	      ...
	      s = <<-EOS.undent_________________________________________________________72
	          ...
	          architectures. OS X itself never installs anything to /home7/tvctopin/gnu so
	...
	def check_missing_deps
	  return unless HOMEBREW_CELLAR.exist?
			'Please run   brew missing ,someting is missing!'
	end
